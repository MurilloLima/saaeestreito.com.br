        ...
        <div class="container my-5 py-5 px-lg-5">
            <div class="row g-5 py-5">
                <div class="col-lg-6 text-center text-lg-start">
                    ...
                    <a href="{{ route('home.pages.licitacao.index') }}" class="btn btn-light py-sm-3 px-sm-5 rounded-pill me-3 animated slideInLeft">
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.1s"
                    ...
                    <div class="service-item d-flex flex-column justify-content-center text-center rounded">
                        ...
                        <a class="btn px-3 mt-auto mx-auto" href="https://api.whatsapp.com/send?phone=5599991940969&text=Oi!" target="_blank">Comunicar</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.3s"
                    ...
                    <div class="service-item d-flex flex-column justify-content-center text-center rounded">
                        ...
                        <a class="btn px-3 mt-auto mx-auto" href="http://177.53.118.12:5661/servicosweb/home.jsf" target="_blank">Acessar</a>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.3s"
                    ...
                    <div class="service-item d-flex flex-column justify-content-center text-center rounded">
                        ...
                        <a class="btn px-3 mt-auto mx-auto" href="http://barrosoptr.dcfiorilli.com.br:5656/SCPIWEB_SAAEESTREITO/" target="_blank">Acessar</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.6s"
                    style="visibility: visible; animation-delay: 0.6s; animation-name: zoomIn;">
